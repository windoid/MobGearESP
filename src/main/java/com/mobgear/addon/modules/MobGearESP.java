// This module was written by windoid, heavily based on the existing ESP module
// in the Meteor client

package com.mobgear.addon.modules;

import com.mobgear.addon.MobgearAddon;
...
public class MobGearESP extends Module {
    ...
    public MobGearESP() {
        super(MobgearAddon.CATEGORY, "MobGearESP", "ESP Module that highlights mobs likely wearing player gear.");
    }
